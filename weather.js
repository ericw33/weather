$(function() {
  var handleWeatherResponse = function(data) {
    ...
    var markup = "<p> Today's Weather is " + data.currently.summary + "<p> The forecast for tomorrow is " + data.daily.data[1].summary + "<p> The forecast for the day after tomorrow is " + data.daily.data[2].summary + "<p> Finally, the forecast for the day after that is " + data.daily.data[3].summary;
